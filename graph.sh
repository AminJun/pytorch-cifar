...
python graph.py -f Train_e_boring.xls Train_e_fast.xls -l 'Boring' 'Fast' -o train_e_100 -d .
python graph.py -f Test_boring.xls Test_fast.xls -l 'Boring' 'Fast' -o Test_100 -d .
python graph.py -f Test_e_boring.xls Test_e_fast.xls -l 'Boring' 'Fast' -o Test_e_100 -d .
